...
class PreviewPrintReqIn extends StatelessWidget {
 ...
 final List<String> listTotalMinta;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Preview Permintaan Masuk")),
      body: PdfPreview(
        build: (format) =>
            generatePdfPermintaanMasuk(
...
Future<Uint8List> generatePdfPermintaanMasuk({required String lastNoPermintaan,
