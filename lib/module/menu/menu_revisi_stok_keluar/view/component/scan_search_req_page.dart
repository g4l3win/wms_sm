...
extension ScanSearchReqPage on RevisiStockKeluarContainer {
  Widget searchReqKeluar(BuildContext context) {
    return Padding(
        ...
        children: [
          ...
          controller.isScanned.isTrue
            ...
            children: [
              Expanded(
                child: Text(
                  "Cari atau pindai nomor permintaan stok keluar yang ingin Anda lihat",
                ),
              ),
            ],
          ),
