...
extension FormPermintaanKeluar on RequestStockOutContainer{
  Widget incomingStockOut({
  ...
  Widget containerDetailStock(BuildContext context) {
    return controller.lsQtyStockOut.isNotEmpty
        ? ListView.builder(
      shrinkWrap: true,
      physics: const AlwaysScrollableScrollPhysics(),
      itemCount: controller.lsQtyStockOut.length,
      itemBuilder: (context, index) {
        ...
        return Column(
          ...
          children: [
            ...
            incomingStockOut(
              indexItem: index,
              textController: controller.lsQtyStockOut[index],
            ),
            const Divider(),
          ],
        );
  ...
  Widget formPermintaanStokKeluar(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 8.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          controller.isScanned.isTrue
            ...
            children: [
              Expanded(
                child: Text(
                  "Tambahkan stok yang Keluar dengan mencari nomor variasi stok atau melakukan scan kode QR",
                ),
              ),
            ],
          ),
